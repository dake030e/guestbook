...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "H4xx0r@Hax.tv", "first!!!"), //
					new GuestbookEntry("Arni", "Arnold@ENVF.de","Hasta la vista, baby"), //
					new GuestbookEntry("Duke Nukem","Duke@Nukem.de",
							"It's time to kick ass and chew bubble gum. And I'm all out of gum."), //
					new GuestbookEntry("Gump1337","FeelGoodFilms@Netlix.de",
